register("Vice Mark 4", function(color, text) {

  /* Vice Mark 4's approach:
   *
   * - Target the lowest numbered enemy
   * - Find its first liberty 
   * - Find the path to that liberty 
   * - Return the first step on that path
   */ 
